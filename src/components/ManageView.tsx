...
export const ManageView: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col bg-gray-50 dark:bg-yt-base overflow-hidden">
      {/* Tab bar */}
      <div className="border-b border-gray-200 dark:border-yt-line bg-white dark:bg-yt-surface px-6">
            ...
            <button
              ...
              className={`px-4 py-3 text-sm font-medium border-b-2 transition-colors ${
                activeTab === tab.key
                  ...
                  : 'border-transparent text-gray-500 dark:text-gray-500 hover:text-gray-700 dark:hover:text-white'
              }`}
            >
              {tab.label}
            </button>
